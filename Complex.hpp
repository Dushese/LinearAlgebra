...
template<typename T>
Complex<T>::Complex(const Complex & obj){ 
    m_real = obj.m_real;
    m_imag = obj.m_imag;
}
...
Complex<T>::Complex(const Complex<T2> & obj){ 
    m_real = obj.m_real;
    m_imag = obj.m_imag;
}

template<typename T>
T Complex<T>::real() const noexcept{ 
    return m_real;
}
...
template<typename T>
T Complex<T>::imag() const noexcept{ 
    return m_imag;
}
...
template<typename T>
template<typename T1> 
Complex<T>& Complex<T>::operator=(const Complex<T1> & obj){
    m_real = obj.m_real;
    m_imag = obj.m_imag;
    return *this;
}
...
template<typename T>
template<typename T1> 
Complex<T>& Complex<T>::operator=(const T1 & obj){
    m_real = obj;
    return *this;
}
...
ostream & operator << (ostream &out, const Complex<T> &obj){
    out << obj.m_real << " ";
    if (obj.m_imag == 0) return out;
    if (obj.m_imag > 0) out << "+ " << obj.m_imag << "*i";
    else out << "- " <<  obj.m_imag << "*i";
